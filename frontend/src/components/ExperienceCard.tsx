...
//       <img src={experience.image_url} alt={experience.title} className="w-full h-48 object-cover" />
//       <div className="p-4">
...
//         <Link to={`/details/${experience.id}`} className="block text-center bg-yellow-400 text-black font-bold py-2 px-4 rounded hover:bg-yellow-500">
//           View Details
//         </Link>
//       </div>
//     </div>
